...
class OctopusClient {
    ...
    Boolean haveFeatureTogglesChanged(byte[] contentHash)
    {
       ...
       URI checkURI = getCheckURI();
        ...
        try {
            ...
            FeatureToggleCheckResponse checkResponse = OctopusObjectMapper.create().readValue(httpResponse.body(), FeatureToggleCheckResponse.class);
    ...
    FeatureToggles getFeatureToggleEvaluationManifest()
    {
        ...
        try {
            ...
            List<FeatureToggleEvaluation> evaluations = OctopusObjectMapper.create().readValue(httpResponse.body(), new TypeReference<List<FeatureToggleEvaluation>>(){}); 
